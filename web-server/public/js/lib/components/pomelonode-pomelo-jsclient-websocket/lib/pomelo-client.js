(function () {
  ...
  pomelo.init = function (params, cb) {
    console.log('pomelo.init', JSON.stringify(params));
    initCallback = cb;
  ...
  var connect = function (params, url, cb) {
    ...
    var onopen = function (event) {
      console.log('pomelo.onopen', JSON.stringify(event));
      if (!!reconnect) {
    ...
    var onmessage = function (event) {
      console.log('pomelo.onmessage', JSON.stringify(event));
  ...
  pomelo.request = function (route, msg, cb) {
    console.log('pomelo.request', route, JSON.stringify(msg));
  ...
  pomelo.notify = function (route, msg) {
    console.log('pomelo.notify', route, JSON.stringify(msg));
    msg = msg || {};
  ...
  var processMessage = function (pomelo, msg) {
    console.log('pomelo.processMessage', JSON.stringify(msg));
